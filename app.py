...
# AZURE_SEARCH_SERVICE_KEY = config("AZURE_SEARCH_SEARVICE_KEY") #os.environ.get("AZURE_OPENAI_KEY")
...
# KB_FIELDS_CONTENT = "content"#config("KB_FIELDS_CONTENT") or 
# KB_FIELDS_CATEGORY = "category"#config("KB_FIELDS_CATEGORY") or 
